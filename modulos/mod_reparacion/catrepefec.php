...
function ponclave(clave,desc){
	/*alert("llego");*/
	opener.document.frm.<?="recl".$n;?>.value = clave
	opener.document.frm.<?="reds".$n;?>.value = desc
	window.close() 
} 
</script>
<meta http-equiv="Content-Type" content="text/html; charset=iso-8859-1" />
<title>Catalogo de Reparacion Efectuada</title>
<style type="text/css">
<!--
...
<table width="100%" border="0" cellspacing="0">
  <tr>
    <td bgcolor="#990000" class="style9">Catalogo de Reparación Efectuada </td>
  </tr>
</table>
<?
