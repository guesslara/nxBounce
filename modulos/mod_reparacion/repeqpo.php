...
.roundedcornr_box_327247 {
	background: url(../img/img_r/roundedcornr_327247_tl.png) no-repeat top left;
}
.roundedcornr_top_327247 {
	background: url(../img/img_r/roundedcornr_327247_tr.png) no-repeat top right;
}
.roundedcornr_bottom_327247 {
	background: url(../img/img_r/roundedcornr_327247_bl.png) no-repeat bottom left;
}
.roundedcornr_bottom_327247 div {
	background: url(../img/img_r/roundedcornr_327247_br.png) no-repeat bottom right;
}
.roundedcornr_content_327247 {
	background: url(../img/img_r/roundedcornr_327247_r.png) top right repeat-y;
}

.roundedcornr_top_327247 div,.roundedcornr_top_327247,
.roundedcornr_bottom_327247 div, .roundedcornr_bottom_327247 {
	width: 100%;
	height: 15px;
	font-size: 1px;
}
...
<!--<table width="100%" border="0" cellspacing="0">
  <tr>
    <td colspan="3" bgcolor="#CC3333"><div align="center" class="style1"><a href="javascript:buscarEquipo()">Buscar Equipo a Reparar</a></div></td>
  </tr>
</table>-->
<blockquote>
  <p>
...
<?
	...
	//numero de orden
	$ot=$row[1];
	$procesoEquipo=$row['process'];
	if($num_rows==0){
?>
<br />
<table width="297" border="0" align="center" cellspacing="1" bordercolor="#333333">
      <tr>
        <th bgcolor="#333333" scope="row"><span class="style13">.</span></th>
      </tr>
      <tr>
      ...
      <tr>
        <th bgcolor="#333333" scope="row"><label></label>
...
<table width="874" border="0" align="center" cellspacing="1" bordercolor="#333333">
  <tr>
    <th colspan="6" bgcolor="#333333" scope="row"><span class="style4">Datos del Equipo-- OT #: <?=$row[1];?><span class="style7">
  ...
  <?
	...
	?>
		<tr>
			<th colspan="6" bgcolor="#333333" class="style7" scope="row">&nbsp;</th>
		</tr>
		<tr>
		<th bgcolor="#CCCCCC" class="style7" scope="row">Equipo Blackberry </th>
		<th colspan="3" bgcolor="" class="style1" scope="row">
		  <div align="left">
			<?
		  ...
		  <th colspan="3" bgcolor="" class="style1" scope="row">
		  	<img src="../img/Spkr.jpg" alt="Detalle de la colocacion del Auricular: Pines hacia arriba" width="132" height="87" align="middle"  />		  </th>
	  </tr>
	<?  
	}
  ?>
 ...
 ?>   	</th>
  ...
  <tr>
    <th colspan="6" scope="row"><hr color="#333333"/></th>
  </tr>
</table>
<?
	...
	//comprobamos el proceso del equipo
	if($procesoEquipo=="NDF"){
?>
		<center>
		<table width="785" border="0" cellpadding="0" cellspacing="0">
			<tr>
				<td>
				<div class="roundedcornr_box_327247">
				   <div class="roundedcornr_top_327247"><div></div></div>
					  <div class="roundedcornr_content_327247">
						 <p class="Estilo1" align="left"><br /><img src="../img/s_warn.png" />&nbsp;
						 Proceso:
						 <?
						 	echo $procesoEquipo;
						 ?>
				   ...
				   <div class="roundedcornr_bottom_327247"><div></div></div>
				</div>
				</td>
			</tr>
		</table>
  ...
  <table width="874" border="0" align="center" cellspacing="0" bordercolor="#000000">
    <tr>
      <th width="559" scope="row"><table width="539" border="0" cellspacing="1" bordercolor="#000000">
          <tr>
            <th colspan="5" bgcolor="#333333" class="style4" scope="row">Datos de Reparacion</th>
          </tr>
          <tr>
      ...
      <th width="311" scope="row"><table width="305" border="0" cellspacing="1">
        <tr>
          <th colspan="3" bgcolor="#333333" class="style4" scope="row">Diagnostico</th>
        </tr>
		<?
			if($status<>"DIAG"){
    ...
    <tr>
      <th colspan="2" scope="row"><hr color="#333333"/></th>
    </tr>
    <?
		if($status<>"DIAG"){
			$result="";
	...
	<tr>
      <th scope="row"><table width="543" border="0" cellspacing="1">
        <tr>
          <th colspan="6" bgcolor="#333333" class="style4" scope="row">Refacc. Utilizadas</th>
        </tr>
        <tr>
	...
	?>
        <tr>
          <th colspan="3" bgcolor="#333333" class="style4" scope="row">Rep. Efectuada</th>
        </tr>
        <tr>
    ...
    <tr>
      <th bgcolor="#333333" class="Estilo1" scope="row"><span class="style4">Refurbished</span>
        <label>
