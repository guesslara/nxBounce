 ...
 * 
 * @package xajax
 * @version $Id: xajaxDefaultRequestProcessorPlugin.inc.php 302 2006-12-13 01:23:14Z gaeldesign $
	...
	function getRequestMode()
 	...
 	function processRequest()
 	{
		...
		if (array_key_exists($sFunctionName, $aFunctions))
		{
			...
			if (!$this->_objXajax->getFlag("allowAllResponseTypes") && !is_a($objTempResponse, 'xajaxResponse')) {
				$this->_outputError("No xajaxResponse Was Returned By Function $sFunctionName.");
				return;
			}
			else if ($this->_objXajax->getFlag("allowAllResponseTypes") && !is_a($objTempResponse, 'xajaxResponse'))
			{
				print $objTempResponse;	
				exit;
			}
