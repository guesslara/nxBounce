    ...
    <?
		...
		if($link==false){
			...
			exit;
                        ...
                        array_push($matriz_tablas,"caps");
                        array_push($matriz_tablas,"catrefacciones");
                        array_push($matriz_tablas,"coddiagnostico");
                        array_push($matriz_tablas,"codfallas");
                        array_push($matriz_tablas,"codrepefect");
                        array_push($matriz_tablas,"prueba_cosmetica");
                        array_push($matriz_tablas,"prueba_funcional");
?>
